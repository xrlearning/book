...
The [Meta XR SDK](../Tools#meta-xr-sdk) connects the virtual environment to the Meta Quest headset and provides the hand and controller interactions used during these activities. Learners can select, grab and manipulate components while receiving immediate visual, audio and haptic feedback as they explore the virtual prototype.
